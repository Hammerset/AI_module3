...
## __mnist_path__ = "/Users/keithd/core/classes/ai-prog/homework/materials/mnist-zip/"

__mnist_path__ = "/home/ivar/Documents/skole/AI/module3/data/mnist-zip/"
...
pyplot.imshow(images[10000])
pyplot.show()

for l in images[10000]:
    print(l)

print("label:", labels[10000])
